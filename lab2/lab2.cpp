...
#include "1.h"
     ...
     */
    {
         ...
         */
        if (pd1 < pd2)
            cout << "pd1 указывает на элемент, который стоит до элемента, на который указывает pd2" << "\n";
        else if (pd1 > pd2)
            cout << "pd1 указывает на элемент, который стоит после элемента, на который указывает pd2" << "\n";
        else
            cout << "pd1 указывает на тот же элемент, что и pd2" << "\n";
    }
    /**
