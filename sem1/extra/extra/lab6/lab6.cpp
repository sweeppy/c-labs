...
// TODO:
// 1. Корректные реакции на пустую библиотеку.
// 2. Реализовать проверку для каждого числового ввода на ввод буквы.
// 3. Реализовать корректный ввод книги - сейчас проскакивают первые 2 пункта
