...
int main()
{
...

    {
        ...
        swap(&nX, &nY);
        cout << "После перестановки с помощью указателей nX = " << nX << ", nY = " << nY << "\n";

        /** а теперь обратно с помощью ссылок на nX и nY */
        swap(nX, nY);
        cout << "После перестановки с помощью ссылок nX = " << nX << ", nY = " << nY << "\n";
     ...
     * сигнализировать об ошибке более вдумчиво.
     *
     ...
     * release версия: assert игнорируется и программа завершает выполнение успешно, однако ее работа совсем некорректна.
     */
...
#define VAR_ARGS(...) var_args(__VA_ARGS__, 0)
     ...
     */
    {
        ...
        cout << endl;
        *my_min(arr, 4) = 0;
        cout << "Наименьший элемент массива после изменения: " << *my_min(arr, 4) << "\n";
    }
