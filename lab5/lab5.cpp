...
int main()
{
         ...
         */
    {
        ...
        while (true)
        {
            ...
            switch (op_symbol)
            {
                ...
                default:
                    printf("Данной оперции нет в списке. Вот полный список операций: \n");
                    print_math_operations();
                    show_result = false;
                    break;
            }
...

    {
        ...
        // Для локальных и динмаичский переменных Book не будет инициализировано

        cout << "Размер объекта Book: " << sizeof(Book) << " байт" << std::endl << std::endl;
     ...
     */
        change_book_field("Лев Толстой", localBook.author);
        change_book_field("Война и мир", localBook.title);
        change_book_field("Роман", localBook.category);
        localBook.price = 500;
        localBook.year = 1867;
