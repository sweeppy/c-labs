...
void change_book_field(const char* src, char*& dst) 
{
...
void editBook(Book &book)
{
    ...
    char command;
        ...
        while(true)
        {
            ...
            print_editBook_commands(edit_commands, sizeof(edit_commands)/8);
...
void editAuthor(char* &author)
{
    ...
    scanf("%255[^\n\r]", new_author);
    change_book_field(new_author, author);
}
void editTitle(char* &title)
{
    ...
    printf("Введите нового автора книги:\n");
    scanf("%255[^\n\r]", new_title);
    change_book_field(new_title, title);
}
...
void editCategory(char* &category)
{
    ...
    {
        case 1:
            change_book_field(categories[0], category);
            break;
        case 2:
            change_book_field(categories[1], category);
            break;
        case 3:
            change_book_field(categories[2], category);
            break;
        case 4:
            change_book_field(categories[3], category);
            break;
        case 5:
            change_book_field(categories[4], category);
            break;
