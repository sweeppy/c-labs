/*
    Дополнительное задание к 2-ой лабораторной.
    Задача: Написать программу, которая переводит 10-ые числа
    в 16-ую СС с помощью сдвигов(аналог первого задания из lab2.cpp)
    и вывести их на экран. Затем выполнить сложение двух чисел в 16-ой
    СС и вывести результут на экран

    * Пример работы программы:
    
    Введите первое число: 
    1325428482
    Ваше первое число в 16-ой СС: 
    4F006F02
    Введите второе число: 
    1
    Ваше второе число в 16-ой СС: 
    00000001
